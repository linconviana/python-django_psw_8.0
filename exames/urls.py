...
urlpatterns = [
    ...
    path('permitir_abrir_exame/<int:id>', views.permitir_abrir_exame, name="permitir_abrir_exame"),
    path('solicitar_senha_exame/<int:id>', views.solicitar_senha_exame, name="solicitar_senha_exame"),
